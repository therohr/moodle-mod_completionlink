...
Developed by David Rohr with the help of AI coding tools. All code is reviewed by the author, tested on local and hosted
Moodle development sites, and checked by Moodle Plugin CI on every change.
